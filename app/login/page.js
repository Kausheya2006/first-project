...
const Login = () => {
    ...
    useEffect(() => {
        ...
        if(session) {
            router.push('/dashboard')   // redirect to /dashboard if we are logged in
        }
      }, [])
    ...
    return (
        <div className='text-white py-14 container-mx-auto'>
            <h1 className='text-center font-bold text-3xl'>Login to start</h1>

            <div className='social-login-buttons'>
                <div className="flex flex-col items-center gap-2 min-h-screen text-white-100 p-10">


                    <button
                        className="flex items-center w-80 border border-white-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white-800 hover:text-white-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white-500">
